          ...
          const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${model}:generateContent`, {
            ...
            body: JSON.stringify({
              ...
              generationConfig: {
                ...
                // 2.5/3.x Flash models "think" before answering by default, and that
                // reasoning is billed against maxOutputTokens — it was silently eating
                // the whole budget and leaving replies cut off mid-sentence. Turn it off
                // for this quick-answer use case (harmless no-op on models that ignore it).
