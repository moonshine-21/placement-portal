...
const ICE_SERVERS = [
  ...
  // TURN relay is what lets calls connect through strict NATs/firewalls.
  // The OpenRelay (openrelay.metered.ca) servers that were listed here are
  // deprecated and frequently unresponsive, which made ICE stall waiting for
  // candidates that never arrive — a big part of "took too long to connect".
  // They've been removed. If calls between two strict-NAT networks fail to
  // connect, add your own TURN credentials from a provider like Twilio or
  // Cloudflare.
];
