    ...
    >
      ...
      >
        {/* Banner + close button — same visual pattern as
            CompanyProfileCardModal. Height matches the edit page (h-32) so
            a banner uploaded there isn't cropped tighter here than what
            the person saw while setting it. */}
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="-mt-10 flex flex-col items-center gap-3 text-center">
              {profile.avatar_url ? (
                <img src={profile.avatar_url} alt="" className="h-20 w-20 rounded-full border-4 border-[var(--bg-elevated)] object-cover" />
              ) : (
                <div className="flex h-20 w-20 items-center justify-center rounded-full border-4 border-[var(--bg-elevated)] bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] text-xl font-bold text-white">
