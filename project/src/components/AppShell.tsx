...
export function AppShell({ currentView, onNavigate, onSignOut, children }: Props) {
  ...
  // mapped to it is always enabled.
  ...
  return (
    <div className="flex min-h-screen">
      ...
      */}
      ...
      >
        {/* Logo/brand row at the very top of the sidebar. */}
        ...
        <nav className="flex-1 overflow-y-auto scroll-thin px-3 py-4">
          ...
          {/* The AI Career Assistant gets its own separate "Tools"
              section, shown only for students (companies don't have this
              feature) and only if the admin hasn't disabled it. */}
          {role === 'student' && isViewEnabled('ai-assistant') && (
            <>
