...
import { StageEnvironment } from '@/components/stage/StageEnvironment';
...
function AppContent() {
  ...
  // Previously useToast/useCallback ran AFTER early returns — that made React
  // re-render unpredictably and was a major flicker source.
  ...
  const renderView = () => {
    switch (effectiveView) {
      case 'dashboard': return <StageEnvironment onNavigate={(v) => setCurrentView(v as ViewKey)} />;
  ...
  return (
    <>
      ...
      <AppShell currentView={effectiveView} onNavigate={handleNavigate} onSignOut={handleSignOut}>
        {renderView()}
      </AppShell>
