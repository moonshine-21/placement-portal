...
// Computed in-memory by src/lib/data.ts's generateJobMatches() — this is
// NOT a database table (see the comment at the top of data.ts for why
// the old `matches` table was abandoned).
