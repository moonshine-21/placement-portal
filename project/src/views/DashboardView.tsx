      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="glass p-6 lg:col-span-2">
          <div className="mb-5 flex items-center justify-between flex-wrap gap-3">
            <h2 className="text-lg font-semibold tracking-tight">Matched Companies</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="glass p-5">
            <h2 className="mb-4 text-sm font-semibold tracking-tight">Profile Completion</h2>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="glass p-5">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-sm font-semibold tracking-tight">Placement Trend</h2>
        ...
        <div className="glass p-5">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-sm font-semibold tracking-tight">Role Demand</h2>
        ...
        <div className="glass p-5">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold tracking-tight">Latest Announcements</h2>
            </div>
  ...
  return (
    <div className="glass card-hover p-5">
      <div className="mb-4 flex items-start justify-between">
        <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent-2)]/15 text-[var(--accent)] shadow-inner">
          <Icon size={20} strokeWidth={1.75} />
        </div>
        {trend === 'up' && <TrendingUp size={16} className="text-[var(--success)]" />}
      </div>
          ...
          {bars && (
            <div className="mt-4 flex items-end gap-1 h-7">
              {[40, 65, 50, 80, 60, 90].map((h, i) => (
                <div key={i} className="flex-1 rounded-t bg-[var(--accent)]/25" style={{ height: `${h}%`, animation: `slide-up 0.5s ease ${i * 0.06}s both` }} />
              ))}
            </div>
          )}
        </>
