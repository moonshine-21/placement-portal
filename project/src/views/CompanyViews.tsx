...
import { Building2, Upload, Save, Users, TrendingUp, Award, Briefcase } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="card overflow-hidden">
        <div className="relative h-32 rounded-t-2xl bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent-2)]/20 overflow-hidden">
          {bannerUrl && <img src={bannerUrl} alt="" className="h-full w-full object-cover" />}
          <label className="absolute bottom-3 right-3 flex cursor-pointer items-center gap-1.5 rounded-lg bg-black/40 px-3 py-1.5 text-xs text-white backdrop-blur-md hover:bg-black/60">
