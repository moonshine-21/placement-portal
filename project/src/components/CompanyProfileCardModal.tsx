        ...
        {loading ? (
          ...
          <>
            ...
            <div className="relative h-[110px] w-full overflow-hidden rounded-t-2xl bg-gradient-to-br from-[var(--accent)]/40 via-[var(--accent-2)]/30 to-[var(--bg-elevated)]">
              ...
              <div className="absolute inset-x-0 bottom-0 h-8 bg-gradient-to-t from-[var(--surface-solid)] to-transparent" />
            ...
            <div className="p-6 pt-0">
              <div className="-mt-10 mb-3 flex items-end gap-3">
                {company.avatar_url ? (
                  <img src={company.avatar_url} alt="" className="h-[72px] w-[72px] rounded-2xl object-cover ring-[5px] ring-[var(--surface-solid)] shadow-lg" />
                ) : (
                  <div className="flex h-[72px] w-[72px] items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] text-white ring-[5px] ring-[var(--surface-solid)] shadow-lg">
                    <Building2 size={28} />
                  </div>
                )}
              </div>
