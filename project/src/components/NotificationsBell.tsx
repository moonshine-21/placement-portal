...
export function NotificationsBell({ onNavigate, open, onOpenChange }: Props) {
  ...
  return (
    <div className="relative">
      ...
      {/* Rendered through a portal to document.body so it always paints
          above every page's content and can never be clipped by the app
          shell's `overflow: hidden` (see AnchoredPortal.tsx). */}
      <AnchoredPortal open={open} anchorRef={buttonRef} onClose={() => onOpenChange(false)}>
        <div className="dropdown-panel w-80 max-h-[420px] flex flex-col animate-slide-down overflow-hidden">
