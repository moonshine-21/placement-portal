    ...
    <div className="flex min-h-screen">
      ...
      */}
      ...
      <div className="flex flex-1 flex-col lg:ml-64 min-w-0">
        ...
        {/* Same reasoning as the sidebar above: this header is `sticky`
            and mounted for the whole session, so it used to force a live
            `backdrop-blur-xl` recalculation on every animated-canvas
            frame. A near-opaque solid background removes that ongoing
            compositor cost (and the flicker it caused) without changing
            how the header looks. */}
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-[var(--border)] bg-[var(--bg-base)]/95 px-4 py-3.5 md:px-6">
