...
import {
  ...
  Calendar, Megaphone, FolderGit2, Bookmark, MessageCircle, FolderKanban,
      ...
      <div className="flex flex-1 flex-col lg:ml-64 min-w-0">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-[var(--border)] bg-[var(--bg-base)]/70 backdrop-blur-xl backdrop-saturate-150 px-4 py-3.5 md:px-6">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            {/* Profile button — matches theme + notification button style
                (rounded-xl square control, same border/hover), with a
            ...
            <div className="relative">
              <button
                ...
                className="flex h-10 w-10 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[var(--border-strong)] bg-[var(--surface)] text-xs font-bold text-[var(--text-secondary)] transition-all hover:border-[var(--accent)] hover:text-[var(--accent)] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[var(--accent)]/10 active:translate-y-0 active:scale-95"
              ...
              >
                {avatarUrl ? (
                  ...
                  <span className="bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] bg-clip-text text-transparent">{initials}</span>
                )}
              </button>
