        ...
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-[var(--border)] bg-[var(--bg-base)]/70 backdrop-blur-xl px-4 py-3.5 md:px-6">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <div className="relative">
              ...
              {themeMenuOpen && (
                <div className="glass absolute right-0 top-12 z-50 w-44 p-2 animate-slide-down" onClick={(e) => e.stopPropagation()}>
            ...
            <NotificationsBell onNavigate={(v) => onNavigate(v as ViewKey)} />
