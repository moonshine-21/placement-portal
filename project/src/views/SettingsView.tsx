...
export function SettingsView({ onSignOut }: Props) {
  ...
  const themes: { key: Theme; label: string; icon: typeof Moon; desc: string }[] = [
    { key: 'dark', label: 'Dark', icon: Moon, desc: 'Premium deep slate' },
    { key: 'light', label: 'Light', icon: Sun, desc: 'Clean and bright' },
    { key: 'aurora', label: 'Aurora', icon: Palette, desc: 'Violet glass glow' },
    { key: 'midnight', label: 'Midnight', icon: Moon, desc: 'Navy with electric blue' },
    { key: 'sunset', label: 'Sunset', icon: Palette, desc: 'Warm amber & rose' },
    { key: 'ocean', label: 'Ocean', icon: Palette, desc: 'Teal coastal calm' },
  ];
