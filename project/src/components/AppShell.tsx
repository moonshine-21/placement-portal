      ...
      */}
      ...
      <div className="flex flex-1 flex-col lg:ml-64 min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          {/* No key={currentView} — that forced a full remount + fade-in
              animation on every navigation AND on any accidental
              effectiveView flip, which looked like continuous blinking.
              Content now updates in place without blanking. */}
