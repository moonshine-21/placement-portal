          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex h-10 w-10 flex-shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-[var(--border-strong)] bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] text-xs font-bold text-white transition-all hover:border-[var(--accent)] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[var(--accent)]/20 active:translate-y-0 active:scale-95"
