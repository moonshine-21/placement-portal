...
function AppContent() {
  ...
  // Arriving here via the "reset password" email link takes priority over
  // everything else — even the loading spinner and an active session —
  // otherwise the visitor lands straight in their normal dashboard with no
